...
public class ConcreteStatService implements IStatService {
	...
	private static final Logger logger = LoggerFactory.getLogger(ConcreteStatService.class);
	...
	public List<Pair<String, Integer>> GetCountryPopulations() {
		logger.info("Started GetCountryPopulations");
		...
		logger.info("Finished GetCountryPopulations");
		return output;
	}
